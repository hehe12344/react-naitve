...
export const hambuger = require("../assets/icons/hambuger.png");
...
export const red-pin = require("../assets/icons/red-pin.png");

export const rice-bowl = require("../assets/icons/rice-bowl.png");
export const salad = require ("../assets/icons/salad.png");
export const search = require("../assets/icons/search.png");
export const shopping-basket = require("../assets/icons/shopping-basket.png");
export const star = require("../assets/icons/star.png");
export const sushi = require("../assets/icons/sushi.png");
export const user = require("../assets/icons/user.png");

export default { back, car, cutlery , donut,drink,fire, hambuger
	,hotdog,fries,like, list,location,mastercard,nearby,noodle,
	pin,pizza,red-pin,rice-bowl,salad,search,shopping-basket,
